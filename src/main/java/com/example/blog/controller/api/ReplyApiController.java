...
public class ReplyApiController {
    ...
    public void createReply(String writer, String content, @PathVariable Long postID) {
        replyService.createReply(writer, content, postID);
    }

    @PutMapping("/api/reply/{replyID}")
    public void updateReply(String writer, String content, @PathVariable Long replyID) {
